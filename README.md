...
Before you begin creating an application with this `devfile` code sample, it's helpful to understand the relationship between the `devfile` and `Dockerfile` & how they contribute to your build. You can find these files at the following URLs:
